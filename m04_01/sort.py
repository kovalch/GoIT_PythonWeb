...
def sort_all_files(path = options.directory_path):
	...
	for subdirectory in subdirectories:
		...
		if name not in sorting_directories:
			...
			for sorting_directory in sorting_directories:
				...
				move_files_to_sorting_directory(subdirectory, os.path.join(subdirectory, sorting_directory), define_all_files(files))
